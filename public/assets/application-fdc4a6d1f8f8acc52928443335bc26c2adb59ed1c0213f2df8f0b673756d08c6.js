...
(function() { this.JST || (this.JST = {}); this.JST["projects/root"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class=\'featured-projects\'>\n</ul>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["shared/sign_in"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Sign In!</h1>\n\n<p>\n\t<a href="/auth/twitter"> Sign In with Twitter?\t</a>\n</p>\n\n<form class=\'sign-in\'>\n\t<label>\n    Email\n    <input type="email" name="user[email]">\n  </label>\n\n  <br>\n\n  <label>\n    Password\n    <input type="password" name="user[password]">\n  </label>\n\n  <br>\n\n  <button>Sign In</button>\n</form>\n');}return __p.join('');};
}).call(this);
