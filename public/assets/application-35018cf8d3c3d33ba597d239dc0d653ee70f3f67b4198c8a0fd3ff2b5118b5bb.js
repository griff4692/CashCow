...
(function() { this.JST || (this.JST = {}); this.JST["projects/backing_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Fund ',  model.escape('title') ,' Project</h1>\n<br>\n<form>\n  <input type="text" name="backing[amount]" value=\'\'>\n  <br>\n  <button class=\'button back-dat-up\'>Back This Project!</button>\n  <br>\n</form>\n<br>\n<h3>\n  Here is a description of the Project\n</h3>\n<br>\n<p>\n  ',  model.escape('description') ,'\n</p>\n<br>\n<a href="/#/projects/',  model.id ,'">Go to Project Page</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/detail"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="/#/projects/',  model.id ,'">\n  ',  model.escape('title') ,'\n</a>\n');  model.backers().models.forEach(function (backer) { ; __p.push('\n  ',  backer.get('fname') ,' gave $',  backer.get('amount') ,' on\n  ');  var dateParts = backer.get('fund_date').split('-') ; __p.push('\n  ',  new Date (dateParts[0], dateParts[1], dateParts[2].slice(0,2)) ,'\n');  }); __p.push('\n');  model.followers().models.forEach(function (follower) { ; __p.push('\n  ',  follower.get('fname') ,' is following this project\n');  }); __p.push('\n',  model.escape('category') ,'\n',  model.escape('description') ,'\n<br>\n');  if (CashCow.currentUser.isSignedIn()) { ; __p.push('\n    ');  if (CashCow.currentUser.followedProjects().where
          ({id: model.id}).length===0) { ; __p.push('\n        <button class=\'follow\' data-id=\'',  model.id ,'\'>\n          Follow This Project\n        </button>\n    ');  } else { ; __p.push('\n      <button class=\'follow\' data-id=\'',  model.id ,'\'>\n        Unfollow This Project\n      </button>\n      <br>\n    ');  } ; __p.push('\n    ');  if (CashCow.currentUser.backedProjects().where
...
(function() { this.JST || (this.JST = {}); this.JST["projects/discover"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class=\'discover-toggle\'>\n  <div class="selection group">\n    <label class=\'category\'>\n      <select class="category-choice" name="category">\n        ');  projCategories.forEach(function (category) { ; __p.push('\n            <option value=\'',  category ,'\'\n             ');  if(category === currentCategory) { ; __p.push('\n               ',  "selected" ,'\n             ');  } ; __p.push('>\n              ',  category ,'\n            </option>\n        ');  }) ; __p.push('\n      </select>\n    </label>\n    <label class=\'order\'><strong id=\'discovery\'>sorted by</strong>\n      <select class="order-choice" name="order">\n        ');  $.each(orderCategories, function (category, value) { ; __p.push('\n            <option value=\'',  category ,'\'\n             ');  if(category === currentOrder) { ; __p.push('\n               ',  "selected" ,'\n             ');  } ; __p.push('>\n              ',  value[1] ,'\n            </option>\n        ');  }) ; __p.push('\n      </select>\n    </label>\n  </div>\n</section>\n\n<ul class=\'discover-result group\'>\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/highlight"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img src="',  model.escape('image_url') ,'" alt="Project Picture">\n\n<section class=\'higlight-container\'>\n  <h1 class=\'highlight highlight-category\'>\n     ',  higlightTitle ,'\n     <strong>\n       ',  model.escape(catToHighlight) ,'\n     </strong>\n  </h1>\n  <h3 class=\'highlight higlight-title\'>\n    ',  model.escape('title') ,'\n  </h3>\n\n  <a class=\'highlight submit proj-button\' href="/#/projects/',  model.id ,'">\n    View This Project\n  </a>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/new_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<br>\n<label>Category:\n\t<select class="category" name="category">\n\t\t<option value="Art"\n\t\t');  if (model.escape('category') === "Art") { ; __p.push('\n\t\t\t',  "selected" ,'\n\t\t');  } ; __p.push('\n\t\t>\n\t\t\tArt\n\t\t</option>\n\t\t<option value="Music"\n\t\t\t');  if (model.escape('category') === "Music") { ; __p.push('\n\t\t\t\t',  "selected" ,'\n\t\t\t');  } ; __p.push('\n\t\t>\n\t\t\tMusic\n\t\t</option>\n\t\t<option value="Philanthropy"\n\t\t\t');  if (model.escape('category') === "Philanthropy") { ; __p.push('\n\t\t\t\t',  "selected" ,'\n\t\t\t');  } ; __p.push('\n\t\t\t>\n\t\t\tPhilanthropy\n\t\t</option>\n\t</select>\n</label>\n<br>\n<label>Title:\n\t<input type="text" name="title", val="',  model.escape('title') ,'">\n</label>\n<br>\n<label>Image URL:\n\t<input type="text" name="image_url" value="',  model.escape('image_url') ,'">\n</label>\n<br>\n<label>Description:\n\t<textarea name="description" rows="8" cols="40">\n\t\t',  model.escape('description') ,'\n\t</textarea>\n</label>\n<br>\n<label> Deadline:\n\t<input type="date" class=\'date\' name="deadline">\n</label>\n<br>\n<label> Funding Goal:\n\t<input type="integer" name="goal">\n</label>\n<br>\n<button class="start-proj">Create New Project!</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/root"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class=\'slide-left\' data-dir=\'1\'>\n  ⟨\n</button>\n\n<button class=\'slide-right\' data-dir=\'-1\'>\n  ⟩\n</button>\n\n<ul class=\'featured-projects group\'>\n</ul>\n\n<script type="text/javascript">\n  $(function () {\n    $(\'.carousel\').carousel();\n  });\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if(type==='highlight') { ; __p.push('\n  <img src="',  model.escape('image_url') ,'" alt="Project Picture">\n\n  <section class=\'higlight-container\'>\n    <h1 class=\'highlight highlight-category\'>\n       ',  higlightTitle ,'',  model.escape(catToHighlight) ,'\n    </h1>\n    <h3 class=\'highlight higlight-title\'>\n      ',  model.escape('title') ,'\n    </h3>\n\n    <a class=\'highlight proj-button\' href="/#/projects/',  model.id ,'">\n      View This Project\n    </a>\n  </section>\n\n');  } else { ; __p.push('\n  <a href="/#/projects/',  model.id ,'">\n    ',  model.escape('title') ,'\n  </a>\n  ');  model.backers().models.forEach(function (backer) { ; __p.push('\n    ',  backer.get('fname') ,' gave $',  backer.get('amount') ,' on\n    ');  var dateParts = backer.get('fund_date').split('-') ; __p.push('\n    ',  new Date (dateParts[0], dateParts[1], dateParts[2].slice(0,2)) ,'\n  ');  }); __p.push('\n  ');  model.followers().models.forEach(function (follower) { ; __p.push('\n    ',  follower.get('fname') ,' is following this project\n  ');  }); __p.push('\n  ',  model.escape('category') ,'\n  ',  model.escape('description') ,'\n  <br>\n  ');  if (CashCow.currentUser.isSignedIn() &&
      CashCow.currentUser.id !== model.user_id) { ; __p.push('\n      ');  if (CashCow.currentUser.followedProjects().where
            ({id: model.id}).length===0) { ; __p.push('\n          <button class=\'follow\' data-id=\'',  model.id ,'\'>\n            Follow This Project\n          </button>\n      ');  } else { ; __p.push('\n        <button class=\'follow\' data-id=\'',  model.id ,'\'>\n          Follow This Project\n        </button>\n        <br>\n      ');  } ; __p.push('\n      ');  if (CashCow.currentUser.backedProjects().where
            ({id: model.id}).length===0) { ; __p.push('\n            <a class=\'fund\' href=\'/#/projects/',  model.id ,'/back\'>\n              Fund This Project\n            </a>\n      ');  } else { ; __p.push('\n        <a class=\'fund\' href=\'/#/projects/',  model.id ,'/back\'>\n          Adjust Your Funding Of This Project (',  CashCow.currentUser.backedProjects().where({id: model.id}) ,')\n        </a>\n        <br>\n      ');  } ; __p.push('\n  ');  } ; __p.push('\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/show/detail"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="/#/projects/',  model.id ,'">\n  ',  model.escape('title') ,'\n</a>\n');  model.backers().models.forEach(function (backer) { ; __p.push('\n  ',  backer.get('fname') ,' gave $',  backer.get('amount') ,' on\n  ');  var dateParts = backer.get('fund_date').split('-') ; __p.push('\n  ',  new Date (dateParts[0], dateParts[1], dateParts[2].slice(0,2)) ,'\n');  }); __p.push('\n');  model.followers().models.forEach(function (follower) { ; __p.push('\n  ',  follower.get('fname') ,' is following this project\n');  }); __p.push('\n',  model.escape('category') ,'\n',  model.escape('description') ,'\n<br>\n');  if (CashCow.currentUser.isSignedIn()) { ; __p.push('\n    ');  if (CashCow.currentUser.followedProjects().where
          ({id: model.id}).length===0) { ; __p.push('\n        <button class=\'follow\' data-id=\'',  model.id ,'\'>\n          Follow This Project\n        </button>\n    ');  } else { ; __p.push('\n      <button class=\'follow\' data-id=\'',  model.id ,'\'>\n        Unfollow This Project\n      </button>\n      <br>\n    ');  } ; __p.push('\n    ');  if (CashCow.currentUser.backedProjects().where
          ({id: model.id}).length===0) { ; __p.push('\n          <a class=\'fund\' href=\'/#/projects/',  model.id ,'/back\'>\n            Fund This Project\n          </a>\n    ');  } else { ; __p.push('\n      <a class=\'fund\' href=\'/#/projects/',  model.id ,'/back\'>\n        Adjust Your Funding Of This Project (',  CashCow.currentUser.backedProjects().where({id: model.id}) ,')\n      </a>\n      <br>\n    ');  } ; __p.push('\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/show/highlight"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img src="',  model.escape('image_url') ,'" alt="Project Picture">\n\n<section class=\'higlight-container\'>\n  <h1 class=\'highlight highlight-category\'>\n     ',  higlightTitle ,'',  model.escape(catToHighlight) ,'\n  </h1>\n  <h3 class=\'highlight higlight-title\'>\n    ',  model.escape('title') ,'\n  </h3>\n\n  <a class=\'highlight proj-button\' href="/#/projects/',  model.id ,'">\n    View This Project\n  </a>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["projects/thumbnail"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'thumbnail\'>\n  <img src="',  model.escape('image_url') ,'" alt="ProjectPicture">\n  <div id="thumbnail-title">\n    ',  model.escape('title') ,'\n  </div>\n\n    <div id=\'thumbnail-name\'>\n      ',  creator.fullName() ,'\n    </div>\n\n  <div class="thumbnail-description">\n    ',  model.blurb(25) ,'\n  </div>\n\n  <ul class="thumbnail-stats group">\n    <li id=\'funded_status\'>\n      <strong>\n        ',  model.fundedStatus().toLocaleString() ,'%\n      </strong>\n      funded\n    </li>\n    <li id=\'amount_funded\'>\n      <strong>\n        $',  (model.escape('amount_funded')/100*100).toLocaleString() ,'\n      </strong>\n      pledged\n    </li>\n\n    <li id=\'days_left\'>\n      <strong>\n        ',  model.escape('days_left').toLocaleString() ,'\n      </strong>\n      days to go\n    </li>\n\n  </ul>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class=\'logo-discovery group\'>\n\t<li class=\'logo\'>\n\t\t<a href="#">\n\t\t\tInsert LOGO\n\t\t</a>\n\t</li>\n\t<li class=\'nav-link\'>\n\t\t <a href="/#/projects/discover/All">\n\t\t\t Discover\n\t\t </a>\n\t</li>\n\t<li class=\'nav-link\'>\n\t\t<a href="/#/projects/new">\n\t\t\tStart\n\t\t</a>\n\t</li>\n</ul>\n<ul class=\'user-menu\'>\n\t');  if (currentUser.isSignedIn()) { ; __p.push('\n\t\t<li class=\'profile-dropdown\'>\n\t\t\t<a href="#/users/',  currentUser.id ,'">\n\t\t\t\t<img src="',  currentUser.image_url ,'" alt="ProfPic">\n\t\t\t</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a id=\'sign-out-link\' href="#blankspace">\n\t\t\t\tSign Out ',  currentUser.fname ,'\n\t\t\t</a>\n\t\t</li>\n\t');  } else { ; __p.push('\n\t\t<a href="/#/session/new">Sign In</a>\n\t\t<a href="/#/users/new">Sign Up</a>\n\t');  } ; __p.push('\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (type==='signUp') { ; __p.push('\n\t');  var dir = 'Up' ; __p.push('\n');  } else { ; __p.push('\n\t');  var dir = 'In' ; __p.push('\n'); 	} ; __p.push('\n\n<form class=\'user-form\'>\n\n\t<h1 class=\'form-header\'>Sign ',  dir ,'</h1>\n\n\t');  if (type==='signUp') { ; __p.push('\n\n\t\t<div class="input">\n\t\t\t\t<input type="text" name="user[fname]"\n\t\t\t\t\t\t\t value="First Name">\n\t\t</div>\n\n\t\t<div class="input">\n\t\t\t<input type="text" name="user[lname]"\n\t\t\t\t\t\t\t value="Last Name">\n\t\t\t</label>\n\t\t</div>\n\n\t\t<div class="input">\n\t\t\t\t<input type="file" name="user[image]" value="Upload A Profile Image">\n\t\t</div>\n\n\t'); 	} ; __p.push('\n\n\t<div class="input">\n    <input type="email" name="user[email]"\n           value="Email">\n\t</div>\n\n\t<div class="input">\n\t    <input type="text" name="user[password]"\n\t           value="Password">\n\t  </label>\n\t</div>\n\n\t<button class=\'submit\'>\n\t\t');  if (type==='signUp') { ; __p.push('\n\t\t\tCreate Account\n\t\t');  } else { ; __p.push('\n\t\t\tSign In\n\t\t');  } ; __p.push('\n\n\t</button>\n\n</form>\n\n<div class=\'twitter-sign-in\'>\n\t<a href="/auth/twitter"> Sign ',  dir ,' with Twitter</a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/profile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('Profile Page\n\n<button class=\'delete-account\'>Delete This Account</button>\n\n<ul class=\'user-stats\'>\n  <li></li>\n</ul>\n\n<section class=\'created-projects\'>\n  <h1>Created Projects</h1>\n  ',  user.createdProjects().length ,'\n</section>\n\n<section class=\'backed-projects\'>\n  <h1>Backed Projects</h1>\n  ',  user.backedProjects().length ,'\n</section>\n\n<section class=\'followed-projects\'>\n  <h1>Followed Projects</h1>\n  ',  user.followedProjects().length ,'\n</section>\n');}return __p.join('');};
}).call(this);
